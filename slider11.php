      ...
      <tbody>
         ...
         <tr style="background: white;">
            <td><img src="uploaded_img/<?php echo $row['image']; ?>" height="100" alt=""></td>
             <td>
               <a href="slider11.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="slider11.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
  ...
  <?php
   ...
   {
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($con, "SELECT * FROM `slider` WHERE id = $edit_id");
