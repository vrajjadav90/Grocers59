...
<section class="display-product-table">
  ...
  <div id="divimg">
    <center><h1 style="font-family: 'Montserrat', sans-serif;color:red;text-align: center;text-decoration: underline;">Order Details</h1></center>
   <table border="3px solid black" cellpadding="6px" bgcolor="#FFF" style="colour:blue">
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM `book_form`");
          ...
          echo "<td>".$row['addtype']."</td>";

          echo "<td>".$row['paymod']."</td>";

         echo "<td><a href=\"ordrdelete.php?id=$row[id]\" onClick=\"return confirm('Are You Sure, You Want to Cancel This Order?')\">Cancel Order</a></td>";
...
<section class="edit-form-container">
   ...
   {
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($conn, "SELECT * FROM `book_form` WHERE id = $edit_id");
