...
{    
     ...
     $land=mysqli_real_escape_string($conn, $_POST['landmark']);
     $town=mysqli_real_escape_string($conn, $_POST['town']);
     $addtype=mysqli_real_escape_string($conn, $_POST['addtype']);
     $payment=mysqli_real_escape_string($conn, $_POST['paymod']);  


    $result = mysqli_query($conn, "UPDATE `book_form` SET `name`='$name',`phone`='$phone',`landmark`='$land',`town`='$town',`addtype`='$addtype',`paymod`='$payment' WHERE id=$id");

    echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Succesfully Updated.....')
    window.location.href='obook17.php';
    </SCRIPT>");
}
        ...
        <nav class="sidebar sidebar-offcanvas bg-gradient-danger"  id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="about16.php"><h4>Manage About</h4></a></li>
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              ...
              <li class="nav-item"> <a class="nav-link" href="gallery20.php"><h3>Sub Main</h3></a></li>
                </ul>
              </div>
            </li>
...
?>
  ...
  <div class="container">
    ...
    <div class="content">
      <form id="registration" action="ordredit.php" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text"  name="landmark" placeholder="Landmark" value="<?php echo $land;?>">
          </div>
          <div class="input-box">
            <span class="details">Town/City:</span>
            <input type="text" name="town" placeholder="Town/City" value="<?php echo $town;?>">
          </div>
          
          <div class="controls">
                             <span class="details">Address type:</span>
                             <select class="form-control option-w3ls" name="addtype" value="<?php echo $addtype;?>">
          ...
          <div class="controls">
                             ...
                             <select class="form-control option-w3ls" name="paymod" value="<?php echo $payment;?>">
