...
if(isset($_POST['add_product']))
{
   ...
   $insert_query = mysqli_query($con, "INSERT INTO `slider2`( image) VALUES( '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($con, "DELETE FROM `slider2` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
      header('location:slider13
        .php');
      $message[] = 'Item has been deleted';
   }
   else
   {
      header('location:slider13.php');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($con, "UPDATE `slider2` SET  image = '$update_p_image' WHERE id = '$update_p_id'");
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($con, "SELECT * FROM `slider2`");
         ...
         <tr style="background: white;">
            <td><img src="uploaded_img/<?php echo $row['image']; ?>" height="100" alt=""></td>
             <td>
               <a href="slider13.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="slider13.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
  ...
  <?php
   ...
   {
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($con, "SELECT * FROM `slider2` WHERE id = $edit_id");
