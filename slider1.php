              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                 <h1> <li class="nav-item"> <a class="nav-link" href="slider1.php"><h3>User Details</h3></a></li>
                  <li class="nav-item"> <a class="nav-link" href="slider2.php"><h3>Add User</h3></a></li>
                </ul>
              </div>
            </li>
              <li class="nav-item">
...
<section class="display-product-table">
  ...
  <div id="divimg">
    <center><h1 style="font-family: 'Montserrat', sans-serif;color:red;text-align: center;text-decoration: underline;">User Details</h1></center>
   <table border="3px solid black" cellpadding="6px" bgcolor="#FFF" style="colour:blue">
      ...
      <?php
        while ($register = mysqli_fetch_assoc($result)) {
          ...
          echo "<td>".$register['password']."</td>";

          echo "<td>".$register['cpassword']."</td>";

          echo "<td><a href=\"usedit.php?id=$register[id]\">Edit</a> | <a href=\"usdelete.php?id=$register[id]\" onClick=\"return confirm('Are you sure you want to delete user?')\">Delete</a></td>";
        }
