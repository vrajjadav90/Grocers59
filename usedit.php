...
if(isset($_POST['update']))
{
    ...
    $unam=mysqli_real_escape_string($con, $_POST['username']);
    ...
    $result = mysqli_query($con, "UPDATE `register` SET `username`='$unam',`email`='$email',`password`='$pass',`cpassword`='$cpass' WHERE id=$id");
  //  $result=mysqli_query($con, "UPDATE register SET username=$unam, email=$email, password=$pass, cpassword=$cpass WHERE id=$id");
...
?>
  ...
  <div class="container">
    ...
    <div class="content">
      <form id="registration" action="usedit.php" method="POST">
        <div class="user-details">
          
          <div class="input-box">
            <span class="details">Username</span>
            <input type="text" name="username" placeholder="Username" value="<?php echo $unam;?>">
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" name="cpassword" placeholder="Confirm Password" value="<?php echo $cpass;?>">
          </div>
        </div>
