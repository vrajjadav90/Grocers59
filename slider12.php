...
if(isset($_POST['add_product']))
{
   ...
   $insert_query = mysqli_query($con, "INSERT INTO `slider1`( image) VALUES( '$p_image')") or die('query failed');
...
if(isset($_GET['delete'])){
   ...
   $delete_query = mysqli_query($con, "DELETE FROM `slider1` WHERE id = $delete_id ") or die('query failed');
   if($delete_query){
      header('location:slider12.php');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($con, "UPDATE `slider1` SET  image = '$update_p_image' WHERE id = '$update_p_id'");
   ...
   <table>
      ...
      <tbody>
         <?php
            ...
            $select_products = mysqli_query($con, "SELECT * FROM `slider1`");
         ...
         <tr style="background: white;">
            <td><img src="uploaded_img/<?php echo $row['image']; ?>" height="100" alt=""></td>
             <td>
               <a href="slider12.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a href="slider12.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
...
<section class="edit-form-container">
  ...
  <?php
   ...
   {
      $edit_id = $_GET['edit'];
      $edit_query = mysqli_query($con, "SELECT * FROM `slider1` WHERE id = $edit_id");
